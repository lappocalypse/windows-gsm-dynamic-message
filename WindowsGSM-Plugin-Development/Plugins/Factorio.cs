...
namespace WindowsGSM.Plugins
{
    public class Factorio : SteamCMDAgent// SteamCMDAgent is used because factorio relies on SteamCMD for installation and update process
    {
        ...
        public override string StartPath => @"bin/x64/server.bat";
        ...
        public string QueryPort = "34197"; // Unsure so far
        ...
        public async Task<Process> Start()
        {
            ...
            string shipWorkingEXEPathFull = Path.Combine(ServerPath.GetServersServerFiles(_serverData.ServerID, StartPath)); // c:\windowsgsm\servers\1\serverfiles\ + bin\x64\server.bat
