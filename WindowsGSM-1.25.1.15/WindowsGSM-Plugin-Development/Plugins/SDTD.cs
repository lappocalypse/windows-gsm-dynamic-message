...
namespace WindowsGSM.Plugins
{
    ...
    /// 
    /// </summary>
    public class SDTD : SteamCMDAgent
    {
        public Plugin Plugin = new Plugin
        {
            name = "WindowsGSM.SDTD",
            author = "Lappocalypse",
            description = "🧩 WindowsGSM plugin for supporting 7 Days to Die Dedicated Server",
            version = "0.1",
            url = "https://github.com/LegendSeeker/WindowsGSM.SDTD", 
        ...
        public SDTD(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
        ...
        public async Task<Process> Start()
        {
            ...
            string configPath = Functions.ServerPath.GetServersServerFiles(_serverData.ServerID, "serverconfig/serverconfig.xml");
            ...
            string param = $"-logfile \"{Path.Combine(workingDir, logFile)}\" -quit -batchmode -nographics -configfile=serverconfig/serverconfig.xml -dedicated {_serverData.ServerParam}";
